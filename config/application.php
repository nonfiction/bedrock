...
$envs = [];
if (env('ENV_DEVELOPMENT')) $envs['development'] = env('ENV_DEVELOPMENT');
if (env('ENV_STAGING'))     $envs['staging']     = env('ENV_STAGING');
if (env('ENV_PRODUCTION'))  $envs['production']  = env('ENV_PRODUCTION');
